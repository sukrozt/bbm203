...
public:
    ...
    void create_rotate_linkedlist(CelestialObject *celestialObject);
    ...
    void hitAsteroidCell();

    void destroyAsteroid(int asteroidOriginalSize);
    ...
    vector<CelestialObject*> all_rotated;
};
